...
func (m *GetTableInfo) MCPTool() (*mcp.Tool, mcp.ToolHandlerFor[domain.TableInfoInput, domain.TableInfoOutput]) {
	metadata := &mcp.Tool{
		Name:        "get_table_info",
		Description: "Get information about a table",
	}

	handler := func(ctx context.Context, req *mcp.CallToolRequest, input domain.TableInfoInput) (
		*mcp.CallToolResult,
